...
ENV OWASP_DEPENDENCY_CHECK_VERSION=5.2.3 SONAR_CLI_VERSION=4.2.0.1873 YARN_VERSION=1.19.1
...
RUN wget -q -O - https://dl-ssl.google.com/linux/linux_signing_key.pub | apt-key add - && \
	...
	apt-get update && \
	apt-get -y install google-chrome-stable vim less psmisc zip unzip net-tools libdbus-glib-1-2 gosu build-essential && \
